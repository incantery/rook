...
pub const c2s = enum(u8) { attach = 1, stdin = 2, resize = 3, detach = 4, stats = 5, shutdown = 6, nav = 7, popup = 8, session = 9, blocks = 10, attach_block = 11, block_cmd = 12, state = 13, capture = 14, side = 15, input = 16, pane_cmd = 17, resume_cmd = 18 };
